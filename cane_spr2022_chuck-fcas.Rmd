...
date: "Spring CANE Meeting --- March 25, 2022"
output:
...
geom_line(aes(color  = distribution), size = 0.5) +
...
- Fitting limited average severity can be easier.
  - Brief research shows lower standard errors scaling the ILFs.
- Not scaling may not solve for the scale parameter.
